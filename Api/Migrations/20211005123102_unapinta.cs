...
{
    public partial class unapinta : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthsToWait = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StringDates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PrescriptionImageId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_Files_PrescriptionImageId",
                        column: x => x.PrescriptionImageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_PrescriptionImageId",
                table: "Requests",
                column: "PrescriptionImageId");
