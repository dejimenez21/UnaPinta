...
namespace UnaPinta.Api.Migrations
{
    ...
    [Migration("20211005123102_unapinta")]
    partial class unapinta
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnaPinta.Data.Entities.File", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("UnaPinta.Data.Entities.Request", b =>
                {
                    ...
                    b.Property<long>("PrescriptionImageId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PrescriptionImageId");
            ...
            modelBuilder.Entity("UnaPinta.Data.Entities.StringDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UnaPinta.Data.Entities.Request", b =>
                {
                    ...
                    b.HasOne("UnaPinta.Data.Entities.File", "Prescription")
                        .WithMany()
                        .HasForeignKey("PrescriptionImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
